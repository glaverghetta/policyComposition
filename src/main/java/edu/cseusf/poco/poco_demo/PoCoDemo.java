...
import edu.cseusf.poco.poco_demo.polymerPolicies.SpamPolicy;
...
import edu.cseusf.poco.policy.examplePolicies.P_trivial;
...
public class PoCoDemo {
	...
	public static void main(String[] args) { 
		...
		String path4SourceFiles = "C:\\Users\\glave\\OneDrive\\Desktop\\Eclipse 2018 Workspace\\policyComposition\\src\\main\\java\\edu\\cseusf\\poco\\poco_demo\\polymerPolicies";
		//String path4absActFiles = path4SourceFiles.concat("/absActions");
		String path4absActFiles = "C:\\Users\\glave\\OneDrive\\Desktop\\Eclipse 2018 Workspace\\policyComposition\\src\\main\\java\\edu\\cseusf\\poco\\poco_demo\\polymerPolicies\\absactions";
		...
		Policy spamEmail = new SpamPolicy();
		//Policy trivial = new P_trivial();
		...
		Policy[] policies = {clientSigned, spamEmail, outgoingMail, checkMem, reflection};
		//Policy[] policies = {incomingMail};
		//System.out.println("right before monitor in main");
