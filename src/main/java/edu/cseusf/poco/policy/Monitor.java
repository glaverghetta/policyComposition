...
public class Monitor{
	...
	public Monitor(String jarFile, Policy[] policies, VC vca, OS pca, String path4SourceFiles, String path4AbsActfiles) {
		//System.out.println("creating a monitor");
		// 1. set vca and pca, 
		_jarFile = jarFile;
		_vc = vca;							
		_os = pca;
		...
		//System.out.println("creating a monitor finished");
	}
	...
	private void compile(String path4SourceFiles, String path4AbsActfiles) { 
		...
		//System.out.println("right before static analysis");
